...
const StockInformation = () => {
  ...
  return (
    <>
      <h1 className='text-3xl text-center'>Ticker Information</h1>
      <div className='stock-information-container'>
        <h1 className='text-2xl text-center text-black'>APPL</h1>
        <div className='grid grid-cols-2'>
          <div className='p-1'>
            <Prices
              priceName={'Open'}
              priceValue={stockData.o}
              color={'green'}
            />
          </div>
          <div className='p-1'>
